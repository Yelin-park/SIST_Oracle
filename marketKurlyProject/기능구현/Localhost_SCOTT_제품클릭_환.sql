...
IS
    ...
    CURSOR img_cursor IS (SELECT file_path FROM product_img WHERE p_code = p_p_code);
    CURSOR detail_cursor IS (SELECT pd_type, pd_content FROM product_detail WHERE p_code = p_p_code);
